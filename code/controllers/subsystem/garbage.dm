SUBSYSTEM_DEF(garbage)
	...
	var/list/collection_timeout = list(2 MINUTES, 10 SECONDS)	// deciseconds to wait before moving something up in the queue to the next level //NSV port of TGMC#4394
