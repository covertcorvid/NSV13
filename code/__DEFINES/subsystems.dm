...
#define INIT_ORDER_JS_OVERMAP		49 //NSV13 - Needs to init BEFORE starsystem.
...
#define FIRE_PRIORITY_JSOVERMAP		380 //NSV13 - JSOvermap priority - could potentially use being even higher.
