...
/datum/ship_weapon/laser_cannon
	...
	overmap_firing_sounds = list('sound/weapons/lasercannonfire.ogg')
	select_alert = "<span class='notice'>Calibrating wave motion gun targeting systems.</span>"
	failure_alert = "<span class='warning'>ERROR: Laser systems are offline.</span>"